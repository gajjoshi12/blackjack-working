                          ...
                          >
                            ...
                            <div className="flex justify-center gap-4 flex-wrap mt-2 mb-4">
                              {gameState?.round_number !== 0 &&
                                ...
                                "playing" &&
                                !gameState.players.player4.hands[0]?.live_function_hand &&
                              ...
                              !["insurence", "surrender"].includes(
                                ...
                                <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none">
                                  <span className="text-5xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] animate-pulse tracking-widest bg-black/60 px-6 py-3 rounded-xl border-4 border-yellow-500 backdrop-blur-sm">
                                    {gameState.players.player4.hands[0].live_function_hand.toUpperCase()}
                                  </span>
                                </div>
                              )}
                          </div>
                                ...
                                >
                                  ...
                                  <div className="flex justify-center gap-2 flex-wrap mt-2 mb-4">
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState.players.player4.split1[0]
                                        .status === "playing" &&
                                      !gameState.players.player4.split1[0]?.live_function_hand &&
                                      (gameState.players.player4
                                        .split1_status === 0 ||
                                        gameState.players.player4
                                          .split2_status === 0) && (
                                  ...
                                  {gameState.players.player4.split1[0]?.live_function_hand &&
                                    !["insurence", "surrender"].includes(
                                      ...
                                      <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none">
                                        <span className="text-5xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] animate-pulse tracking-widest bg-black/60 px-6 py-3 rounded-xl border-4 border-yellow-500 backdrop-blur-sm">
                                          {gameState.players.player4.split1[0].live_function_hand.toUpperCase()}
                                        </span>
                                      </div>
                                    )}
                                </div>
                                ...
                                >
                                  ...
                                  <div className="flex justify-center gap-2 flex-wrap mt-8">
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState.players.player4.split2[0]
                                        .status === "playing" &&
                                      !gameState.players.player4.split2[0]?.live_function_hand &&
                                      (gameState.players.player4
                                        .split1_status === 0 ||
                                        gameState.players.player4
                                          .split2_status === 0) && (
                                  ...
                                  {gameState.players.player4.split2[0]?.live_function_hand &&
                                    !["insurence", "surrender"].includes(
                                      ...
                                      <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none">
                                        <span className="text-5xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] animate-pulse tracking-widest bg-black/60 px-6 py-3 rounded-xl border-4 border-yellow-500 backdrop-blur-sm">
                                          {gameState.players.player4.split2[0].live_function_hand.toUpperCase()}
                                        </span>
                                      </div>
                                    )}
                                </div>
